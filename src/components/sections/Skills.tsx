          ...
          <AnimatePresence mode="popLayout">
            {displayedSkills.map((skill) => (
              <motion.div
                ...
                className="group relative flex items-center gap-2.5 px-3 py-2.5 bg-slate-800/80 border border-slate-700/80 rounded-lg cursor-pointer hover:-translate-y-0.5 hover:border-sky-500/50 hover:bg-slate-800/95 hover:shadow-[0_4px_15px_rgba(56,189,248,0.1)] transition-all duration-300"
              >
                ...
                {/* Hover Tooltip */}
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 -translate-y-full w-48 p-2.5 bg-slate-900/95 border border-slate-700 shadow-xl text-xs text-slate-300 rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-20 text-center pointer-events-none leading-relaxed">
                  {skill.desc}
